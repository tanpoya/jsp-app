...
//    out.println(result);
             	...
             	*********************************/
             	...
             	// 화면에 찍어보기
             	out.println("<h1>");
             	out.println("<br> # 전체개수:" + totalCnt+"개<br>");
             	out.println("<br> # 페이지당개수:" + onePageCnt+"개<br>");
             	out.println("<br> # 남은 레코드수:" + etcRecord+"개<br>");
             	out.println("<br> # 리스트 그룹수:" + listGroup+"개<br>");
             	out.println("</h1>");
